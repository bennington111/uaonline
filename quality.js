(function () {
    ...
    var JACRED_URL = Lampa.Storage.get('jacred.xyz') || 'jacred.xyz'; // URL JacRed
    ...
    // Стили для отображения качества - Чёрная полупрозрачная подложка, белый текст
    var style = "<style id=\"maxsm_ratings_quality\">" +
        ...
        "   background-color: rgba(0, 0, 0, 0.7) !important; " + // Чёрная полупрозрачная подложка
    ...
    function applyQualityToCard(card, quality, source, qCacheKey) {
        ...
        // Удаляет существующие элементы качества
        ...
        // Сохраняет в кеш если данные от JacRed
    ...
    function updateCards(cards) {
        for (var i = 0; i < cards.length; i++) {
            ...
            (function (currentCard) {
                ...
                // Если нет кеша - запрашивает у JacRed
                else {
