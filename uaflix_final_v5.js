...
(function () {
    ...
    Lampa.Listener.follow('full', function (e) {
        if (e.type === 'complite') {
            const button = $(`<div class="full-start__button selector view--uaflix" data-subtitle="uaflix ${mod_version}">
            ...
            button.on('hover:enter', function () {
                let title = e.data.title || (Lampa.Activity.active().data.title);
                if (!title) return;
